-- ==============================================
-- YENİ TRIGGER'LAR - EKİPMAN ENVANTERİ İÇİN
-- ==============================================

-- Önce eski trigger'ları sil (eğer varsa)
DROP TRIGGER IF EXISTS equipment_delete_trigger;
DROP TRIGGER IF EXISTS equipment_update_trigger;
DROP TRIGGER IF EXISTS equipment_insert_trigger;
DROP TRIGGER IF EXISTS inventory_change_tracker;
DROP TRIGGER IF EXISTS inventory_update_tracker;
DROP TRIGGER IF EXISTS soft_delete_trigger;
...
-- Trigger'lar oluşturuldu mesajı
SELECT 'Yeni trigger\'lar başarıyla oluşturuldu!' as mesaj;
SELECT 'Oluşturulan trigger\'lar:' as trigger_listesi;
SELECT '1. equipment_delete_trigger - Ekipman silindiğinde MAC/seri durumunu günceller' as trigger_aciklama;
SELECT '2. equipment_update_trigger - Ekipman güncellendiğinde MAC/seri durumunu günceller' as trigger_aciklama;
SELECT '3. equipment_insert_trigger - Ekipman eklendiğinde MAC/seri durumunu günceller' as trigger_aciklama;
SELECT '4. inventory_change_tracker - Yeni ekipman eklendiğinde hareket kaydı oluşturur' as trigger_aciklama;
SELECT '5. inventory_update_tracker - Ekipman güncellendiğinde hareket kaydı oluşturur' as trigger_aciklama;
SELECT '6. soft_delete_trigger - Soft delete işlemi için geçmiş kaydı oluşturur' as trigger_aciklama; 